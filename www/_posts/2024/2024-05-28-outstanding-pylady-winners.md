...
Abigail ([X][abigail_x], [LinkedIn][abigail_li]) hails from the 🇬🇭 Ghana 🇬🇭 chapter of PyLadies 
...
Maaya Ishida ([X][maaya_x], [LinkedIn][maaya_li], [Facebook][maaya_fb]) joins us from our 🇯🇵 
[Tokyo PyLadies chapter][tokyo_site] 🇯🇵 ([connpass][tokyo_conn], [Facebook][tokyo_fb], [X][tokyo_x],
...
[caravan] 🚐, which is a series of events over the last 5 years, with the purpose of connecting with
